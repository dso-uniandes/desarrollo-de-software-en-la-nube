...
def test_get_shared_url_returns_http_link(tmp_path):
    ...
    url = s3_local.get_shared_url(str(file_path))
...
def test_s3_get_object_reads_bytes(tmp_path, monkeypatch):
    ...
    data = s3_local.s3_get_object(str(file_path))
